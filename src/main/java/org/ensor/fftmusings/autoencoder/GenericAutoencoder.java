    ...
    public static void evaluateModel(Autoencoder model, int epoch) {
        ...
        try (FFTOverlap.Reader wavFileIterator = FFTOverlap.createReader(inputFilename)) {
            new Pipeline(new Layer.FFTDToINDArray())
                .add(new GenericProcessor.Encode(model.getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Encode(model.getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Encode(model.getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Encode(model.getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Encode(model.getSourceAutoencoder()))
                ...
                .add(new GenericProcessor.Decode(model.getSourceAutoencoder()))
                .add(new GenericProcessor.Decode(model.getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Decode(model.getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Decode(model.getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder()))
                .add(new GenericProcessor.Decode(model.getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder().getSourceAutoencoder()))
