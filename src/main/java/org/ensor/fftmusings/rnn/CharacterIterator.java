...
public class CharacterIterator implements DataSetIterator {
     ...
     * @param numExamplesToFetch Total number of examples to fetch (must be
     * multiple of miniBatchSize). Used in hasNext() etc methods
     * @param validCharacters Character array of valid characters. Characters
     * not present in this array will be removed
     * @param rng Random number generator, for repeatability if required
     * @param alwaysStartAtNewLine if true, scan backwards until we find a new
     * line character (up to MAX_SCAN_LENGTH in case of no new line characters,
     * to avoid scanning entire file)
